...
export const stubData: Record<string, StubPageData> = {
  ...
  "inteligencia-de-mercado": {
    ...
    blocks: [
      ...
      { type: "bullets", heading: "Perguntas que podemos ajudar a responder", items: [
        "Qual é o tamanho e a configuração possível da oportunidade?",
        "Quem já oferece respostas semelhantes e como se posiciona?",
        "O que os públicos valorizam, rejeitam ou ainda não encontram?",
        "Que tendências realmente afetam o projeto e quais são apenas ruído?",
        "Que barreiras de adoção, operação ou regulação precisam ser consideradas?",
        "Que segmentos merecem prioridade?",
        "O que precisa ser testado antes de uma decisão maior?",
      ]},
      ...
      { type: "bullets", heading: "O que uma pesquisa responsável não promete", items: [
        "Inteligência de mercado reduz incerteza, mas não elimina risco nem prevê o futuro com exatidão. Toda conclusão depende da qualidade das fontes, do recorte, do acesso aos públicos e do momento analisado. Premissas, limitações e lacunas são apresentadas junto com as recomendações.",
      ]},
    ],
  ...
  "diagnostico-e-planejamento": {
    ...
    blocks: [
      ...
      { type: "bullets", heading: "O que investigamos", items: [
        "contexto organizacional e histórico;",
        "objetivos, resultados e indicadores existentes;",
        "estrutura, papéis e governança;",
        "processos e fluxos de decisão;",
        "públicos, clientes, usuários ou comunidades;",
        "equipe, competências e capacidade disponível;",
        "recursos, restrições e dependências;",
        "riscos, conflitos e iniciativas anteriores.",
      ]},
      ...
      { type: "bullets", heading: "Aplicações frequentes", items: [
        ...
        "Preparação para expansão ou mudança de posicionamento.",
        "Definição de prioridades em PMEs.",
      ]},
      { type: "bullets", heading: "Planejamento que reconhece limites", items: [
        "Um plano responsável não presume equipe, orçamento ou dados que não existem. Ele explicita dependências, escolhas e renúncias. Quando o diagnóstico aponta que a organização ainda não possui condições para executar determinada iniciativa, o planejamento deve incluir como construir essa capacidade, e não apenas estabelecer uma data otimista.",
      ]},
    ],
  ...
  "estruturacao-de-projetos": {
    ...
    blocks: [
      ...
      { type: "bullets", heading: "Projetos que podemos estruturar", items: [
        ...
        "A natureza do projeto define quais especialistas, documentos e validações adicionais serão necessários.",
      ]},
      { type: "bullets", heading: "Viabilizar não é prometer aprovação ou captação", items: [
        "A Creation pode estruturar o projeto, identificar caminhos, preparar materiais e apoiar a interlocução. A decisão de contratar, patrocinar, aprovar ou financiar pertence a terceiros e depende de critérios que não controlamos. Nossa responsabilidade é aumentar a consistência, a clareza e a capacidade de execução da proposta, sem transformar possibilidade em garantia.",
      ]},
    ],
  ...
  gestao: {
    ...
    blocks: [
      ...
      { type: "bullets", heading: "Gestão não é apenas acompanhamento", intro: "Acompanhar significa observar o que aconteceu. Gerir significa criar as condições para que as próximas decisões aconteçam no tempo certo. Nosso papel pode incluir:", items: [
        ...
        "manter cronograma, orçamento, riscos e decisões atualizados;",
        "tratar impedimentos e dependências;",
        "preparar informações para fóruns executivos;",
        "registrar mudanças de escopo;",
        "acompanhar indicadores e entregas;",
        "organizar encerramento e lições aprendidas.",
      ]},
      { type: "cards", heading: "Formas de atuação", items: [
        { title: "Gestão integral do projeto", description: "Assumimos a coordenação desde a estruturação até o encerramento, dentro das responsabilidades contratadas." },
        { title: "PMO do projeto ou portfólio", description: "Criamos e operamos a estrutura de governança, padrões, informações e acompanhamento para uma ou várias iniciativas." },
        { title: "Extensão da equipe", description: "Acrescentamos capacidade temporária de gestão a uma área interna, agência, produtora ou organização parceira." },
        { title: "Implantação de processos e governança", description: "Estruturamos o sistema e acompanhamos sua adoção até que a equipe consiga operá-lo." },
      ]},
      { type: "bullets", heading: "O que permanece com o cliente", items: [
  ...
  "gestao-de-projetos": {
    ...
    blocks: [
      { type: "bullets", heading: "O problema nem sempre é o planejamento inicial", intro: "Muitos projetos começam com um cronograma e uma lista de tarefas. O problema surge quando a realidade muda e ninguém consegue responder rapidamente:", items: [
        "qual versão do plano está valendo;",
        "quem decide cada tema;",
        "o que está atrasado e qual é o efeito;",
        "quais riscos precisam de ação;",
        "que fornecedor ou área depende de quem;",
        "quanto já foi comprometido;",
        "o que precisa ser levado à liderança.",
        "Gestão de projetos cria essa visão comum e a transforma em rotina de decisão.",
      ]},
      { type: "cards", heading: "Escopo possível", items: [
      ...
      { type: "bullets", heading: "Trabalho integrado, responsabilidades explícitas", intro: "A proposta define:", items: [
        ...
        "quem lidera tecnicamente;",
        "o que a Creation coordena;",
        "o que as equipes internas executam;",
        "quais fornecedores respondem por entregas específicas;",
        "como mudanças e exceções serão aprovadas.",
        "Não assumimos, por linguagem comercial, responsabilidades que o contrato e a governança não transferiram.",
      ]},
      { type: "bullets", heading: "Para quem", items: [
  ...
  inovacao: {
    ...
    parentHref: "/solucoes",
    blocks: [
      { type: "bullets", heading: "Inovar para produzir mudança, não apenas movimento", items: [
        "Programas de inovação podem gerar muitas ideias e pouca decisão. Isso acontece quando o desafio é amplo demais, os critérios não estão claros, os participantes não têm acesso às informações necessárias ou ninguém assume a continuidade.",
        "Nosso trabalho liga investigação, desenho de programa, mobilização, experimentação, governança e execução.",
      ]},
      ...
      { type: "bullets", heading: "Entregáveis possíveis", items: [
        ...
        "Conteúdo e materiais de facilitação.",
        "Plano de mentorias e avaliação.",
        "Backlog de hipóteses e experimentos.",
        "Plano de pilotos.",
        "Modelo de governança.",
        "Relatório de resultados e recomendações.",
      ]},
      { type: "bullets", heading: "Formatos adequados ao problema", items: [
        "Hackathon, sprint, laboratório, chamada aberta, workshop e programa de aceleração são meios diferentes. A escolha depende do tipo de desafio, do conhecimento disponível, da diversidade necessária, do tempo de decisão e da capacidade de absorção da organização.",
        "Não recomendamos um formato antes de compreender a pergunta que ele precisa responder.",
      ]},
      { type: "bullets", heading: "Da participação à continuidade", items: [
        "Um programa bem desenhado deixa claro o que acontecerá com as propostas, quais decisões são possíveis e quais recursos estão disponíveis depois da etapa de mobilização.",
        "Quando a continuidade depende de validações futuras, isso também precisa ser informado. Transparência preserva a confiança de participantes e parceiros.",
      ]},
      { type: "steps", heading: "Como trabalhamos", items: [
  ...
  impacto: {
    ...
    blocks: [
      ...
      { type: "bullets", heading: "Entregáveis possíveis", items: [
        ...
        "O método e o grau de evidência são definidos conforme a pergunta, o estágio do programa, os dados disponíveis e o investimento previsto.",
      ]},
      { type: "bullets", heading: "Responsabilidade social conectada à gestão", items: [
        "Para áreas corporativas de responsabilidade social, sustentabilidade e investimento social privado, podemos atuar na estruturação de programas, seleção e gestão de parceiros, governança, acompanhamento de portfólio, prestação de contas e comunicação responsável.",
        "Não substituímos auditoria, asseguração, parecer jurídico ou certificação. Quando essas funções forem necessárias, integramos profissionais habilitados ao trabalho.",
      ]},
      { type: "bullets", heading: "Participação não é um item de checklist", items: [
        "As pessoas afetadas por um programa possuem conhecimento sobre o problema, o território e as consequências das escolhas. Definimos formas de escuta e participação compatíveis com o contexto, respeitando consentimento, proteção de dados, acessibilidade e assimetrias de poder.",
        "Nem toda decisão pode ser compartilhada, mas toda promessa de participação deve ser verdadeira.",
      ]},
      { type: "steps", heading: "Como trabalhamos", items: [
        { number: "01", title: "Compreender", description: "Contexto, públicos, dados, iniciativas existentes e decisões necessárias." },
        { number: "02", title: "Formular", description: "Mudança pretendida, hipóteses, estratégia, escopo e critérios." },
        { number: "03", title: "Estruturar", description: "Governança, parceiros, recursos, plano, riscos e indicadores." },
        { number: "04", title: "Realizar", description: "Coordenação, acompanhamento, aprendizagem e ajustes." },
        { number: "05", title: "Avaliar", description: "Evidências, limitações, resultados, contribuição e recomendações." },
      ]},
    ],
...
export const homeCapacidades: HomeCapacidade[] = [
  {
    ...
    description: "Investigamos o contexto, organizamos informações e transformamos complexidade em direção. A estratégia define o problema, orienta as escolhas e constrói um caminho viável para o projeto.",
  ...
  },
  {
    ...
    description: "Transformamos direção em escopo, responsabilidades e decisões. Estruturamos governança, equipes, processos e indicadores para que o projeto avance com ritmo, controle e transparência.",
