...
export const stubData: Record<string, StubPageData> = {
  ...
  estrategia: {
    ...
    blocks: [
      ...
      {
        type: "bullets",
        heading: "Entregáveis possíveis",
        intro: "Conforme o escopo, a frente de Estratégia pode produzir:",
        items: [
      ...
      {
        type: "bullets",
        heading: "Onde essa capacidade é aplicada",
        intro: "A Estratégia pode ser mobilizada em projetos de:",
        items: [
          "Inovação.",
  ...
  "inteligencia-de-mercado": {
    ...
    blocks: [
      ...
      },
      {
        ...
        intro: "O formato depende da pergunta, mas pode incluir:",
        items: [
          "Plano de pesquisa.",
  ...
  "estruturacao-de-projetos": {
    ...
    blocks: [
      ...
      {
        type: "bullets",
        heading: "Projetos que podemos estruturar",
        items: [
  ...
  "gestao-de-projetos": {
    ...
    blocks: [
      ...
      {
        type: "cards",
        heading: "PMO no tamanho que o contexto exige",
        intro: "PMO não precisa significar uma estrutura pesada ou permanente.",
        items: [
      ...
      {
        type: "bullets",
        heading: "O que pode ser entregue",
        items: [
  ...
  "governanca-e-indicadores": {
    ...
    blocks: [
      ...
      {
        type: "bullets",
        heading: "Para projetos, programas e operações",
        items: [
  ...
  operacoes: {
    ...
    blocks: [
      ...
      {
        type: "bullets",
        heading: "Onde entramos",
        intro: "A Creation pode assumir toda a operação ou uma frente delimitada. Também pode integrar estruturas já existentes, incluindo:",
        items: [
  ...
  "producao-executiva": {
    ...
    blocks: [
      ...
      {
        type: "bullets",
        heading: "Controles que sustentam a entrega",
        items: [
  ...
  "receptivo-drivers-locacoes": {
    ...
    blocks: [
      ...
      {
        type: "bullets",
        heading: "Informações que organizamos",
        items: [
  ...
  inovacao: {
    ...
    blocks: [
      ...
      {
        type: "bullets",
        heading: "Perguntas que organizam um programa",
        items: [
  ...
  "branding-experiencias": {
    ...
    blocks: [
      ...
      {
        type: "bullets",
        heading: "Experiências que podem ser estruturadas",
        items: [
          "Ativações de marca.",
  ...
  "como-trabalhamos": {
    ...
    blocks: [
      ...
      {
        type: "bullets",
        heading: "Responsabilidades claras antes da execução",
        intro: "Cada proposta deve definir:",
        items: [
      ...
      {
        type: "bullets",
        heading: "Ferramentas a serviço do projeto",
        intro: "SWOT, PESTEL, BPMN, Canvas, Design Thinking, Lean, Kanban, Scrum, RACI, OKRs e outras ferramentas podem ser utilizadas quando ajudam a responder uma pergunta real. Não aplicamos uma ferramenta porque ela é conhecida — escolhemos o recurso pelo problema, pela maturidade da equipe e pela decisão que precisa ser tomada.",
        items: ["SWOT e PESTEL", "BPMN e Canvas", "Design Thinking e Lean", "Kanban e Scrum", "RACI e OKRs"],
      },
    ],
