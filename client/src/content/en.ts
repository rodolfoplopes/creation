...
export const en: Content = {
  ...
  contact: {
    ...
    description:
      "You don't need to arrive with a finished scope. Explain the context, the current stage and the expected deliverable. The first conversation is meant to understand the challenge and figure out whether Creation is the right structure to lead it.",
    form: {
      name: "Name",
      ...
      whatsappPlaceholder: "With country/area code (optional)",
      organization: "Organization or project",
      organizationPlaceholder: "Company, brand, initiative or project name",
      projectType: "What can we help with?",
      ...
      projectTypes: [
        ...
        "Location, Fixer and Rio Operations",
        "Creation Solution",
        "Not sure yet",
        "Other",
      ],
      projectStage: "What stage is the project at?",
      projectStagePlaceholder: "Select the stage",
      projectStages: [
        "There's just an idea or a need",
        "We're researching and weighing paths",
        "The project needs to be structured",
        "The project has started and needs management",
        "The delivery needs production or operations",
        "We need to measure or document results",
        "Another stage",
      ],
      location: "Where will the project happen?",
      locationPlaceholder: "City, state, country or digital environment",
      deadline: "Is there an important date or deadline?",
      deadlinePlaceholder: "Give the date or write \"to be defined\"",
      message: "Tell us the challenge",
      messagePlaceholder: "What needs to happen, what already exists, and where's the main difficulty?",
      consent: "I authorize Creation to use this information to review and respond to my inquiry, in accordance with the Privacy Policy.",
      submit: "Send project",
      sending: "Sending...",
      confirmationMessage: "We've received your message. We'll review the context and respond through the channel you provided.",
    },
    aside: {
      title: "Talk directly to Creation",
      ...
      note: "We take on projects in Brazil and collaborate with agencies, production companies, creators and international teams.",
    },
    process: {
      title: "What happens after you reach out?",
      steps: [
        "We read the context and check the challenge's fit.",
        "We ask for additional information, when needed.",
        "We schedule an initial conversation with the relevant people.",
        "We define whether the next step is a diagnosis, a brief, a proposal or a referral.",
      ],
      note: "Not every inquiry needs to become a proposal. When a challenge isn't within our capacity or availability, we'll respond with transparency.",
    },
  },
