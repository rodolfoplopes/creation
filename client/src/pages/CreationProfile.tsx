      ...
      <section className="relative min-h-[80vh] flex items-center hero-gradient-main overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl">
            ...
            >
              Strategic positioning, narrative construction and image
              architecture for executives and high-impact leaders.
            </p>
      ...
      <section className="py-20 bg-bone">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Creation Profile is a premium strategic product for building
              executive profile, narrative and positioning. We start with
              research, diagnosis and strategic intent, and only then move to
              execution.
            </p>
          </div>
        </div>
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="relative z-10 w-16 h-16 rounded-full bg-gradient-to-br from-petroleo to-petroleo-dark flex items-center justify-center mb-6 shadow-lg border-4 border-ouro/30">
                    <span className="text-xl font-bold text-ouro">
                      {step.number}
                    </span>
                  </div>
